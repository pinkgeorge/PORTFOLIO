	...
	public Skill() {
		...
		Interests.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				Interests.setIcon(arrowleftPressed);
			}
			@Override
			public void mouseExited(MouseEvent e) {
				Interests.setIcon(arrowLeft);
			}
		});
		Interests.setBounds(138, 410, 31, 33);
		...
		contentPane.add(BG);
		BG.setIcon(new ImageIcon("E:\\Eclipse codes\\Portfolio\\Images\\A3_SKILLS.png"));
