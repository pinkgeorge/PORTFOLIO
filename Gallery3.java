...
public class Gallery3 extends JFrame {
	...
	public Gallery3() {
		...
		Gallery2.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseEntered(MouseEvent e) {
				Gallery2.setIcon(arrowleftPressed);
			}
			@Override
			public void mouseExited(MouseEvent e) {
				Gallery2.setIcon(arrowLeft);
			}
		});
		Gallery2.setBounds(560, 390, 29, 27);
		contentPane.add(Gallery2);
		
		JLabel BG = new JLabel("");
		BG.setIcon(new ImageIcon("E:\\Eclipse codes\\Portfolio\\Images\\B3_GALLERY.png"));
